...
export const routes: Routes = [
  ...
  { path: 'create-prescription', component: UserGetAppointmentsComponent, canActivate: [AuthGuard] },
  { path: 'update-prescription/:id', component: UserGetAppointmentsComponent, canActivate: [AuthGuard] },
